#GUI FILE
from mainSecondWindow import QColor, QMainWindow, Qt, QSizeGrip, QGraphicsDropShadowEffect
...
class UIFunctions(QMainWindow):
    ...
    def maximize_restore(self):
        ...
        if status == 0:
            ...
            self.ui.frame.setGeometry(500, 200, 941, 861)
            ...
            self.ui.frame.setGeometry(40, 30, 941, 861)
